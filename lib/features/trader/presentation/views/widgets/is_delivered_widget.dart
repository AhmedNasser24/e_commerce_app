...
class _IsDeliveredWidgetState extends State<IsDeliveredWidget> {
  ...
  Widget build(BuildContext context) {
    return isDelivered
        ...
        : CustomButton(
            title: S.of(context).is_it_delivered,
            style: AppStyle.medium14,
            backGroundColor: kWhiteColor,
            horizontalPadding: 6,
            verticalPadding: 0,
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Align(
            ...
            child: Text(
              "${S.of(context).did_you_sent_orders_to}\n$customerName",
          ...
          content: Column(
            ...
            children: [
              ...
              const Gap(10),
              ListTile(
                title: Text(S.of(context).yes, style: AppStyle.medium14),
                onTap: () {
              ...
              ListTile(
                title: Text(S.of(context).not_yet, style: AppStyle.medium14),
                onTap: () {
                  Navigator.pop(context);
                },
              ),
